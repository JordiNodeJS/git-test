...
create table estacion(nom_estacion varchar(20) primary key) ENGINE = InnoDB;;
create table metodo_reproduccion(nom_metodo varchar(20) primary key) ENGINE = InnoDB;;
create table planta(
  nom_cientific varchar(20) primary key,
  nom_popular varchar(20),
  floracio VARCHAR(20),
  FOREIGN KEY(floracio) REFERENCES estacion(nom_estacion)
) ENGINE = InnoDB;;
CREATE TABLE adob(
...
CREATE TABLE dosi_adob(
  nom_planta varchar(20),
  nom_estacion varchar(20),
  nom_adob varchar(20),
  quantitat_adob SMALLINT(3) NOT NULL CHECK (quantitat_adob >= 20 AND quantitat_adob <= 100),
  PRIMARY KEY(nom_planta, nom_estacion, nom_adob),
  FOREIGN KEY(nom_planta) REFERENCES planta(nom_cientific),
  FOREIGN KEY(nom_estacion) REFERENCES estacion(nom_estacion),
...
CREATE TABLE reproduccion (
    ...
    FOREIGN KEY(nom_planta) REFERENCES planta(nom_cientific),
    FOREIGN KEY(metode_reproduccio) REFERENCES metodo_reproduccion(nom_metodo)
) ENGINE = InnoDB;
...
INSERT INTO estacion VALUES ('Estiu');
INSERT INTO estacion VALUES ('Hivern');
INSERT INTO estacion VALUES ('tardor');


INSERT INTO metodo_reproduccion VALUES ('Esqueix');
INSERT INTO metodo_reproduccion VALUES ('Capficats');
INSERT INTO metodo_reproduccion VALUES ('Estaques');
INSERT INTO metodo_reproduccion VALUES ('Bulbs');
INSERT INTO metodo_reproduccion VALUES ('Estolons');
INSERT INTO metodo_reproduccion VALUES ('Llavors');
...
INSERT INTO reproduccion VALUES('Esqueix', 'Geranium', 'Alt');
INSERT INTO reproduccion VALUES('Esqueix', 'Begonia rex', 'Alt');
INSERT INTO reproduccion VALUES('Capficats', 'Begonia rex', 'Alt');
INSERT INTO reproduccion VALUES('Llavors', 'Begonia rex', 'Baix');
INSERT INTO reproduccion VALUES('Estaques', 'Rosa', 'Mitjà');
INSERT INTO reproduccion VALUES('Bulbs', 'Rosa', 'Alt');
INSERT INTO reproduccion VALUES('Estolons', 'Chlorophytum', 'Alt');
INSERT INTO reproduccion VALUES('Esqueix', 'Cyclamen', 'Alt');
INSERT INTO reproduccion VALUES('Capficats', 'Cyclamen', 'Mitjà');
INSERT INTO reproduccion VALUES('Capficats', 'Philodendron', 'Alt');
INSERT INTO reproduccion VALUES('Esqueix', 'Philodendron', 'Alt');
